					...
					<dl class="article-detail-row">
						...
						<dd class="article-detail-data">
							...
							<c:if test="${not empty notice.fileSrc}">
								<!-- 파일 다운로드 -->
								<a href="${pageContext.request.contextPath}/upload/${notice.fileSrc}" download>
									${notice.fileSrc}
								</a>
								<!-- 이미지 미리보기 -->
								<br/>
								<img src="${pageContext.request.contextPath}/upload/${notice.fileSrc}"
								     alt="${notice.fileSrc}"
								     style="max-width:500px; margin-top:10px; border:1px solid #ccc;"/>
							</c:if>
